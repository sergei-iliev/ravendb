...
INSTANCE;
    ...
    private void initRoutes() {
        //get
    	 ...
    	 httpGetRouteList.put("/administration/payment/eligibleusers/comments", new Route(new PaymentController(),"getRedeemingRequestComments"));
    	 httpGetRouteList.put("/administration/payment/eligibleusers/comments/add", new Route(new PaymentController(),"comments"));
    	 ...
    	 httpPostRouteList.put("/administration/payment/eligibleusers/comments", new Route(new PaymentController(),"saveRedeemingRequestComments"));
    	 httpPostRouteList.put("/administration/payment/eligibleusers/comments/add", new Route(new PaymentController(),"addComments"));
