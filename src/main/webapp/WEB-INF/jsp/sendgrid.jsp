...
<jsp:param name="activeMenuItem" value="sendgrid" />
</jsp:include>
<div class="container">
<c:if test="${error}">
...
<form:form method="POST"  action="/email/sendgrid/send" modelAttribute="email" enctype="multipart/form-data">
  <div class="form-group row">
    <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Send Grid Email address</label>
    <div class="col-sm-10">
